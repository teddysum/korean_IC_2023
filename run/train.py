...
def main(args):
    ...
    train_dataloader = ImageCaptioningDataLoader("./resource/data/final-image/img" ,"resource/data/nikluge-gips-2023-train.jsonl", feature_extractor, decoder_tokenizer, args.batch_size)
    valid_dataloader = ImageCaptioningDataLoader("./resource/data/final-image/img", "resource/data/nikluge-gips-2023-dev.jsonl", feature_extractor, decoder_tokenizer, args.valid_batch_size)
