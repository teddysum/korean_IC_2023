...
def main(args):
    ...
    dataloader = ImageCaptioningDataLoader("./resource/data/final-image/img", "resource/data/nikluge-gips-2023-test.jsonl", feature_extractor, decoder_tokenizer, args.batch_size, mode="infer")
    ...
    j_list = jsonlload("resource/data/nikluge-gips-2023-test.jsonl")
